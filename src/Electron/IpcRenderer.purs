...
foreign import send :: forall a eff. Channel -> a -> Eff (electron :: ELECTRON | eff) Unit
...
foreign import sendSync :: forall a eff. Channel -> a -> Eff (electron :: ELECTRON | eff) Unit
...
foreign import sendToHost :: forall a eff. Channel -> a -> Eff (electron :: ELECTRON | eff) Unit
